...
import './NewEvent.css';
import { addData } from '../operations';
...
class NewEvent extends Component {
    ...
    addition = (event) => {
        ...
        array.splice(parseInt(event.target.id,10)+1,0,place);
        array1.splice(parseInt(event.target.id,10)+1,0,price);
       this.setState({
           places: array,
           prices: array1,
       });
    ...
    addtodb= ()=> {
        ...
        .then(data=>{
            if(data.data.status){
                ...
                toast.success("Package Created Scuccessfully !", {
                    position: toast.POSITION.TOP_CENTER
                  });
            }
            else{
                toast.error("Cannot Create a Package !", {
                    position: toast.POSITION.TOP_CENTER
                  });
            }
        })
...
fileget=(data)=>{
    ...
    render() {
        return (
          ...
          <h5 className="text-center mb-3 text-info black pt-5">New Package</h5>
                  ...
                  <div id="login-column" className="col-md-6">
                      <div id="login-box" className="col-md-12">
                          ...
                          <div className="form-group">
                                  ...
                                  <input type="text" name="name" id="name" className="form-control" onChange={this.gotdata} required/>
                              </div>
                             <div className="form-group">
                                  <label className="text-info">Bus No</label>
                                  <input type="number" name="no" id="no" className="form-control" onChange={this.gotdata} required/>
                              </div>
                              <div className="form-group">
                                  <label className="text-info">Source</label>
                                  <input type="text" name="source" id="source" className="form-control" onChange={this.gotdata} required/>
                              </div>
                              <div className="form-group">
                                  <label  className="text-info">Destination</label>
                                  <input type="text" name="destination" id="destination" onChange={this.gotdata} className="form-control" required/>
                              </div>
                             <div className="form-group">
                          ...
                          <div class="custom-file">
                              ...
                              <div className="form-group">
                                  ...
                                  <input type="text" name="price" id="price" className="form-control" onChange={this.gotdata} required/>
                              </div>
                              <div className="row">
